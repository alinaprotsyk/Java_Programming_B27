...
public class VariablePractice {
    public static void main(String[] args) {
        ...
        System.out.println(age); // printing age variable, which means I will print the value of the variable
        System.out.println("age"); // this prints the character age, no variable that has a number value
