...
Sender: <James Bond>. From Number: [202-123-3456]. + Message: {"I love programming and problems solving"}
...
Separate these parts and print them separately:
    ...
    Message: actualMessage
         ...
         */
    String msg = "Sender: <James Bond>. From Number: [202-123-3456]. + Message: {\"I love programming and problems solving\"}";
